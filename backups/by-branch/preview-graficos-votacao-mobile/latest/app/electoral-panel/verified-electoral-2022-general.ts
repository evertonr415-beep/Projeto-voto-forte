 ...
 * "PR - Votação por seção eleitoral - 2022". Nenhuma votação abaixo é
 * estimada ou projetada.
 *
 * Governador e Senador possuem a lista completa de candidatos. Para
 * Deputado Federal e Deputado Estadual, o painel mantém os 30 mais votados
 * no município e identifica explicitamente a cobertura como `top-candidates`.
 */
export const VERIFIED_ARAPONGAS_2022_GENERAL_OFFICES: VerifiedGeneralOffice2022[] = [
  {
    ...
    coverage: "complete",
    sourceLabel: "TSE — apuração 2022 em Arapongas/PR, 100% das seções",
  ...
  },
  {
    ...
    sourceLabel: "TSE — apuração 2022 em Arapongas/PR; 30 mais votados",
    sourceUrl: TSE_2022_PR_SOURCE,
    candidates: [
  ...
  },
  {
    ...
    sourceUrl: TSE_2022_PR_SOURCE,
    candidates: [
      { name: "Tiago Amaral", ballotNumber: "—", party: "PSD", votes: 15471, percentage: 26.65 },
      { name: "Pedro Paulo Bazana", ballotNumber: "—", party: "PSD", votes: 9843, percentage: 16.96 },
      { name: "Aroldo Pagan", ballotNumber: "—", party: "PODE", votes: 5486, percentage: 9.45 },
      { name: "Marcio Nunes", ballotNumber: "—", party: "PSD", votes: 2974, percentage: 5.12 },
      { name: "Cobra Repórter", ballotNumber: "—", party: "PSD", votes: 2190, percentage: 3.77 },
      { name: "Delegado Jacovos", ballotNumber: "—", party: "—", votes: 1403, percentage: 2.42 },
      { name: "Alex Canziani", ballotNumber: "—", party: "—", votes: 968, percentage: 1.67 },
      { name: "Arilson Chiorato", ballotNumber: "—", party: "PT", votes: 818, percentage: 1.41 },
      { name: "Cantora Mara Lima", ballotNumber: "—", party: "—", votes: 785, percentage: 1.35 },
      { name: "Professor Lemos", ballotNumber: "—", party: "PT", votes: 669, percentage: 1.15 },
      { name: "Alisson Wandscheer", ballotNumber: "—", party: "—", votes: 668, percentage: 1.15 },
      { name: "Tercilio Turini", ballotNumber: "—", party: "PSD", votes: 617, percentage: 1.06 },
      { name: "Alexandre Amaro", ballotNumber: "—", party: "—", votes: 612, percentage: 1.05 },
      { name: "Ricardo Arruda", ballotNumber: "—", party: "—", votes: 611, percentage: 1.05 },
      { name: "Requião Filho", ballotNumber: "—", party: "PT", votes: 518, percentage: 0.89 },
      { name: "Jairo Tamura", ballotNumber: "—", party: "—", votes: 435, percentage: 0.75 },
      { name: "César Mello", ballotNumber: "—", party: "—", votes: 413, percentage: 0.71 },
      { name: "Alexandre Curi", ballotNumber: "—", party: "PSD", votes: 390, percentage: 0.67 },
      { name: "Sargento França", ballotNumber: "—", party: "—", votes: 380, percentage: 0.65 },
      { name: "Evandro Araujo", ballotNumber: "—", party: "PSD", votes: 323, percentage: 0.56 },
      { name: "Michele Thomazinho", ballotNumber: "—", party: "—", votes: 305, percentage: 0.53 },
      { name: "Rodolfo Mota", ballotNumber: "—", party: "—", votes: 300, percentage: 0.52 },
      { name: "Boca Aberta Jr", ballotNumber: "—", party: "—", votes: 281, percentage: 0.48 },
      { name: "Cloara Pinheiro", ballotNumber: "—", party: "PSD", votes: 275, percentage: 0.47 },
      { name: "Michele Caputo", ballotNumber: "—", party: "—", votes: 269, percentage: 0.46 },
      { name: "Renato Freitas", ballotNumber: "—", party: "PT", votes: 247, percentage: 0.43 },
      { name: "João Bettega", ballotNumber: "—", party: "—", votes: 245, percentage: 0.42 },
      { name: "Professora Josete", ballotNumber: "—", party: "PT", votes: 226, percentage: 0.39 },
      { name: "Flavia Francischini", ballotNumber: "—", party: "—", votes: 221, percentage: 0.38 },
      { name: "Gilberto Ribeiro", ballotNumber: "—", party: "—", votes: 221, percentage: 0.38 },
    ],
  },
];
