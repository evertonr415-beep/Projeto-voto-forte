...
function renderPanel(
  ...
  panel.innerHTML = `
    <div class="vf-origin-head"><div><h3>🧭 Origem das Respostas da Enquete</h3><p>“Via disparo” usa o histórico identificado do Monitor, com nome e telefone quando já reconhecidos pelo sistema. “Via link” mantém as participações web sem identificação pessoal.</p></div><button type="button" class="vf-origin-refresh">↻ Atualizar</button></div>
    ...
    <p class="vf-origin-note">Nenhum voto ou resposta é alterado. Esta tela apenas organiza os dados já existentes.</p>
  `;
}
