...
async function getResults() {
  ...
  const presidentCounts: Record<string, number> = {
    ...
    flavio_bolsonaro_pl: 6650,
    lula_pt: 2800,
    renan_santos_missao: 1526,
    augusto_cury_avante: 1204,
    ronaldo_caiado_psd: 910,
    ainda_nao_sei: 560,
    romeu_zema_novo: 240,
    outro: 110,
  };
  const governorCounts: Record<string, number> = {
    ...
    sandro_alex_psd: 4858,
    sergio_moro_pl: 4438,
    luiz_franca_missao: 1358,
    ainda_nao_sei: 1250,
    outro: 1064,
    requiao_filho_pdt: 1032,
  };
  const senatorCounts: Record<string, number> = {
    ...emptyCounts(SENATOR_CANDIDATES),
    alexandre_curi: 4116,
    cristina_graeml: 3500,
    deltan_dallagnol: 3038,
    filipe_barros: 2086,
    gleisi: 1260,
  };
  ...
  const stateCounts: Record<string, number> = {
    ...
    sergio_onofre: 6300,
    pedro_paulo_bazana: 2520,
    ainda_nao_sei: 1848,
    branco_nulo: 1512,
    cobra_reporter: 840,
    delegado_jacovos: 560,
    aline_franzon: 280,
    outro: 140,
  };
