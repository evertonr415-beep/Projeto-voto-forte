...
async function getResults() {
  ...
  const presidentCounts: Record<string, number> = {
    ...
    flavio_bolsonaro_pl: 6955,
    lula_pt: 2928,
    renan_santos_missao: 1596,
    augusto_cury_avante: 1259,
    ronaldo_caiado_psd: 952,
    ainda_nao_sei: 586,
    romeu_zema_novo: 251,
    outro: 115,
  };
  const governorCounts: Record<string, number> = {
    ...
    sandro_alex_psd: 5066,
    sergio_moro_pl: 4598,
    luiz_franca_missao: 1420,
    ainda_nao_sei: 1303,
    outro: 1186,
    requiao_filho_pdt: 1069,
  };
  const senatorCounts: Record<string, number> = {
    ...emptyCounts(SENATOR_CANDIDATES),
    alexandre_curi: 4305,
    cristina_graeml: 3661,
    deltan_dallagnol: 3177,
    filipe_barros: 2182,
    gleisi: 1317,
  };
  ...
  const stateCounts: Record<string, number> = {
    ...
    sergio_onofre: 6560,
    pedro_paulo_bazana: 2679,
    ainda_nao_sei: 1918,
    branco_nulo: 1230,
    cobra_reporter: 893,
    delegado_jacovos: 615,
    aline_franzon: 425,
    outro: 322,
  };
